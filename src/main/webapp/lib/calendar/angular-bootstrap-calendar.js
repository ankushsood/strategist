...
angular
  ...
  .directive('mwlCalendar', function() {
    ...
    return {
      template: '<div mwl-dynamic-directive-template name="calendar" overrides="vm.customTemplateUrls"><span class="glyphicon glyphicon-plus"><a href="">aaaaaaaaaaa</a></span></div>',
      restrict: 'E',
      scope: {
        events: '=',
        view: '=',
